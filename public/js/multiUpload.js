...
(function ($) {
    ...
    $.fn.spartanMultiImagePicker = function (options) {
        ...
        function addRow(settings, el) {
            last_index = count;
            var groupClassName = settings.groupClassName, rowHeight = settings.rowHeight, fieldName = settings.fieldName, isRemove = settings.isRemove, placeholderImage = settings.placeholderImage, dropFileLabel = settings.dropFileLabel;
